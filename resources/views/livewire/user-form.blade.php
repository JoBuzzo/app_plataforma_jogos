<form wire:submit.prevent="save">
    ...
    <div class="grid grid-cols-2 gap-6 mb-6">
        <div>
            ...
            @error('name') <span class="absolute text-sm text-red-500">{{ $message }}</span> @enderror
        </div>
        <div>
            ...
            @error('nick') <span class="absolute text-sm text-red-500">{{ $message }}</span> @enderror
        </div>
    </div>
    <div class="mb-6">
        ...
        @error('email') <span class="absolute text-sm text-red-500">{{ $message }}</span> @enderror
    </div>
    <div class="mb-6">
        ...
        <input type="password" id="password" wire:model="password"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="•••••••••">
        @error('password') <span class="absolute text-sm text-red-500">{{ $message }}</span> @enderror
    </div>
    <div class="mb-6">
        ...
        <input type="password" id="password_confirmation" wire:model="password_confirmation"
            ...
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="•••••••••">
        @error('password_confirmation') <span class="absolute text-sm text-red-500">{{ $message }}</span> @enderror
    </div>
    <div class="mb-6">
        <div class="flex items-start">
            ...
            <label for="terms" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Eu concordo com <a
                    href="#" class="text-blue-600 hover:underline dark:text-blue-500">termos e condições</a>.</label>
        </div>
        @error('terms') <span class="absolute text-sm text-red-500">{{ $message }}</span> @enderror
    </div>
