...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 relative" x-data="{ mobile: false }">

    <div class="container flex flex-wrap items-center justify-between mx-auto">
        <a href="#" class="flex items-center">
            {{-- <img src="" class="h-6 mr-3 sm:h-9" alt="" /> --}}
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Nome do site</span>
        </a>
        <div class="flex items-center md:order-2 space-x-3 relative" x-data="{ user: false }">
            <x-dark-mode-button />
            ...
            <div x-show="user" x-transition class="user-dropdown">
                <div class="px-4 py-3">
                    <span class="block text-sm text-gray-900 dark:text-white">João Lucas Buzzo</span>
        ...
        <div class="hidden md:block">
            <ul
                ...
                <li>
                    <a href="#" class="link-no-active">About</a>
                </li>
                <li>
                    <a href="#" class="link-no-active">Services</a>
                </li>
                <li>
                    <a href="#" class="link-no-active">Pricing</a>
                </li>
                <li>
                    <a href="#" class="link-no-active">Contact</a>
                </li>
            </ul>
        </div>

    </div>
    <div x-show="mobile" class="right-1 top-12 h-96 absolute py-4">
